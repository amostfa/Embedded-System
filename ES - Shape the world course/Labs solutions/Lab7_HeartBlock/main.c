...
// This is  a solution to lab 7 - Course: Embedded system -shape the world on Edx
// Solved by: Ahmed

//The goal is to build a pacemaker
// The template was already provided. 
